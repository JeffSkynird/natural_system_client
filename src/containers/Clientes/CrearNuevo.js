        ...
        <Box mt={2} mb={2} ml={2} mr={2}>
                            ...
                            <Grid item md={12} xs={12}>
                                ...
                                <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                                    <AccordionSummary
                                        ...
                                        id="panel1bh-header"
                                    >
                                        <Typography className={classes.heading}><PersonIcon fontSize="small" style={{marginRight:5}}/>Datos personales</Typography>
                                                ...
                                                <Grid item container spacing={2}>
                                                    ...
                                                    <Grid item xs={12} md={4}>
                                                        <FormControl
                                                            ...
                                                            error={validation.civil_name == null}
                                                        >
                                                            <InputLabel id="label1">Proyecto donde compro</InputLabel>
                                                            <Select
                                                                labelId="label1"
                                                                onChange={(e) => setProyectoR(e.target.value)}
                                                                value={proyectoR}
                                                                label="Proyecto donde compro"
                                                            >
                                                                <MenuItem value="">
                                                                    <em>Seleccione una opción</em>
                                                                </MenuItem>
                                                                ...
                                                                {proyectoData.map((e) => (
                                                                    ...
                                                                    <MenuItem key={e.id_proyecto} value={e.id_proyecto}>
                                                                        <em>{e.pry_descrip}</em>
                                                                    </MenuItem>
                                                                ))}
                                                            </Select>
                            ...
                            <Grid item md={12} xs={12}>
                                ...
                                <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                                    ...
                                    >
                                        ...
                                        <Typography className={classes.secondaryHeading}>Sueldo y egresos</Typography>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                        <Grid container spacing={1}>
                                            <Grid item xs={12} md={12}>
            ...
            */}
                            <Grid item xs={12} md={12}>
                                ...
                                <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                                    <AccordionSummary
                                        ...
                                        id="panel2bh-header"
                                    >
                                        <Typography className={classes.heading}><FileCopyIcon fontSize="small" style={{marginRight:5}} />Documentación</Typography>
                                        <Typography className={classes.secondaryHeading}>
                                            Formato pdf y de 2MB máximo
                                        </Typography>
                                    </AccordionSummary>
                                    <AccordionDetails>
                            ...
                            {civil == 2 || civil == 3 || civil == 6 ? (
                                <Accordion expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
                                    <AccordionSummary
                                        ...
                                        id="panel4bh-header"
                                    >
                                        <Typography className={classes.heading}><PeopleIcon fontSize="small" style={{marginRight:5}} />Datos del cónyuge</Typography>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                        <Grid container spacing={1}>
                                            <Grid item xs={12}>
                ...
                <CardActions>
                    ...
                    <Button startIcon={<CallToActionIcon />} variant="contained" color="default" onClick={() => vaciar()}>
                        Limpiar
                    </Button>
