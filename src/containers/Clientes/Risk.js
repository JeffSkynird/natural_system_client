...
import { cambiarRisk} from "../../utils/API/clientes";
...
export default function Risk(props) {
    ...
    React.useEffect(()=>{
        if(props.location.state!=null){
            setRisk(props.location.state.risk_status)
    ...
    const asignar=()=>{
        ...
        cambiarRisk({client_id:props.location.state.id,status:risk},initializer)
     }
    ...
    return (
        <Box  mt={2} ml={2} mr={2}>
            <Box>
                ...
                <Typography color="textPrimary">Asignación (RIESGO)</Typography>
            </Breadcrumbs>
            </Box>
          <Grid container>
