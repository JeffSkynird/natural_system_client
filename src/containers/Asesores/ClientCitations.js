...
import { obtenerTodosPorCliente,eliminarCitation} from '../../utils/API/citation.js'
            ...
            <Grid container>
                <Grid item xs="12">
                    <MaterialTable
                                icons={TableIcons}
                                columns={[
                                    { title: "Fecha de creación", field: "creado_en"},
                                 

                                    { title: "Título", field: "titulo" },
                                    { title: "Descripción", field: "descripcion" },
                                    { title: "Dirección", field: "id_direccion" },

                                    { title: "¿Es efectiva?", field: "is_effective" },
