...
import { obtenerTodos,eliminarPais} from '../../utils/API/countries.js'
...
export default function Clientes(props) {
    ...
    const eliminar=()=>{
        eliminarPais(open.id,initializer,cargarData)
           ...
           <Dialog
            ...
            >
                ...
                <DialogContentText id="alert-dialog-slide-description">
                    ¿Está seguro de eliminar el país?
                </DialogContentText>
                </DialogContent>
                <DialogActions>
            ...
            <Grid container justify='space-between' alignItems="center" style={{marginBottom:'10px'}}>
                ...
                <Box>
                  {/*   <Button style={{marginRight:'5px'}}  startIcon={<AddCircleOutline />} variant="contained" color="secondary" onClick={()=>props.history.push("/clientes/crear")}>
                    ...
                    <Button  startIcon={<AddCircleOutline />} variant="contained" color="secondary" onClick={()=>props.history.push('/paises/crear')}>
                        Crear
                    </Button>
                                ...
                                actions={[
                                    {
                                        ...
                                        onClick: (event, rowData) => props.history.push("/paises/editar",rowData)
                                    },
