...
import { obtenerTodos,eliminarSupervisor} from '../../utils/API/supervisors.js'
...
export default function Supervisores(props) {
    ...
    const eliminar=()=>{
        eliminarSupervisor(open.id,initializer,cargarData)
           ...
           <Dialog
            ...
            >
                ...
                <DialogContentText id="alert-dialog-slide-description">
                    ¿Está seguro de eliminar el supervisor?
                </DialogContentText>
                </DialogContent>
                <DialogActions>
            ...
            <Grid container justify='space-between' alignItems="center" style={{marginBottom:'10px'}}>
                <Box>
                    ...
                    <Typography color="textPrimary">Supervisores</Typography>
                </Breadcrumbs>
                </Box>
                <Box>
                  {/*   <Button style={{marginRight:'5px'}}  startIcon={<AddCircleOutline />} variant="contained" color="secondary" onClick={()=>props.history.push("/clientes/crear")}>
                    ...
                    <Button  startIcon={<AddCircleOutline />} variant="contained" color="secondary" onClick={()=>props.history.push('/supervisores/crear')}>
                        Crear
                    </Button>
                ...
                <Grid item xs="12">
                    <MaterialTable
                                ...
                                columns={[
                                    ...
                                    { title: "Teléfono", field: "landline", type: "numeric" },
                                ...
                                actions={[
                                    {
                                        ...
                                        onClick: (event, rowData) => props.history.push("/supervisores/editar",rowData)
                                    },
