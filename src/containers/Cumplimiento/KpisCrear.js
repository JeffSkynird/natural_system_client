...
import { registrarKpi } from "../../utils/API/kpis";
...
export default function KpisCrear(props) {
    const initializer = useContext(Initializer);

    const dato = props.location.state;
    const edicion = props.location.pathname == "/kpis/crear" ? true : false;
    ...
    return (
        <Box mt={2} ml={2} mr={2}>
            ...
            >
                ...
                <Link color="inherit" onClick={() => props.history.push("/kpis")}>
                    KPI
        </Link>
