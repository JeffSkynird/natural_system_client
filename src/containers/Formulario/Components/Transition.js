...
export default function Transition(props) {
  ...
  return (
    ...
    textAlign: 'center',
    padding: '0px 60px'}}>
              ¡Estas a punto de <span style={{fontWeight: 'bold'}}>ganar $2.000* de descuento</span> en el precio de tu futura casa y muchos premios más!
          </p>
    ...
    height: '40px'
            ...
            <p style={{  color:'white',  fontSize: '11px',marginTop:'10px',textAlign: 'center',
    padding: '0px 45px',}}>
