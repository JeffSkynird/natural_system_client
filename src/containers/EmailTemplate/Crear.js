...
import { registrar, uploadAttach } from "../../utils/API/templates";
...
import fondo from '../../assets/LogoAmbiensa.png';
...
export default function Crear(props) {
  ...
  const edicion =
    props.location.pathname == "/email_templates/crear" ? true : false;
  ...
  const subirAdjunto = (id) => {
    uploadAttach({ template_file: templateFile, template_id: id }, initializer);
  };
            ...
            <Grid container spacing={3}>
              <Grid item md={6}>
                <Grid container spacing={2}>
                  ...
                  {emailModo != 6 ? (
                    <Grid item md={12} xs={12}>
                      <p style={{ marginTop: "0px", paddingLeft: "10px" }}>
                      ...
                      {etiquetas.map((e) => (
                        <Chip
                          ...
                          label={e.label}
                          onClick={() => añadirEtiqueta(e.valor)}
                        />
                      ))}
                    </Grid>
                  ) : (
                  ...
                  <Grid item md={12} xs={12}>
                    <FormControl variant="outlined" style={{ width: "100%" }}>
                      <InputLabel id="demo-simple-select-filled-label">
                        Seleccione modo de envío automático
                      </InputLabel>
                      <Select
