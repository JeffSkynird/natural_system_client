...
import { editar } from "../../utils/API/promociones";
    ...
    return (
        <Box mt={2} ml={2} mr={2}>
            ...
            <Card>
                ...
                <CardActions>
                    <Button startIcon={<SaveOutlinedIcon />} variant="contained" color="secondary" onClick={() => editarPromocion()}>
                        Guardar
                    </Button>
